...
<div class="container mt-4">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body row">
      <div class="col-md-3">
        <strong>কাস্টমার নাম:</strong> <span id="customer_name"></span>
      </div>
      <div class="col-md-3">
        <strong>বর্তমান বকেয়া:</strong> <span id="current_due">৳0</span>
      </div>

      <div class="col-md-3">
        <strong>মোবাইল:</strong> <span id="customer_mobile"></span>
      </div>
      <div class="col-md-3">
        <strong>ঠিকানা:</strong> <span id="customer_address"></span>
      </div>
    </div>
  </div>
